...
const initial: Form = { name: "", email: "", city: "", phone: "", age: "", jobs: "", savings: "", pathway: "", ready: "" };

const steps = [
  { title: "About you", fields: ["name", "email", "city", "phone"] as (keyof Form)[] },
              ...
              <div className="space-y-4">
                {step === 0 && (
                  <div className="grid sm:grid-cols-2 gap-3">
                    ...
                    <Field label="City in Canada" value={form.city} onChange={(v) => update("city", v)} placeholder="Toronto, Calgary..." />
                    <Field label="Phone number" type="tel" value={form.phone} onChange={(v) => update("phone", v)} placeholder="+1 647 000 0000" />
                  </div>
                )}
